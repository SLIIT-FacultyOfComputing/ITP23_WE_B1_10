...
<html lang="en">
	<head>
		<title>PatientHub | View Clinic Schedule</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">PatientHub | View Clinic Schedule</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15 text-bold">View <span class="text-bold">Clinic Schedule</span></span></span></h5>
